<?php
/**
 * Blog Listing Page Template (home.php)
 *
 * This template is used when a static front page is set and
 * displays the blog posts listing with AJAX filtering.
 *
...
// Get current category for initial state
$current_category = "";
if (is_category()) {
    $current_category = single_cat_title("", false);
}

// Query args for initial load
...
<main id="primary" class="site-main blog-main">
    <div class="blog-container">
        ...
        <div class="posts-grid blog-posts-grid" id="posts-container" 
             ...
             data-max-pages="<?php global $wp_query; echo $wp_query->max_num_pages; ?>"
             data-category="all">
            <?php
            if (have_posts()) :
                $post_index = 0;
