 ...
 * 
 * This template displays all blog posts with AJAX filtering and pagination.
 *
...
// Custom query for all posts with pagination
...
<main id="primary" class="site-main blog-main">
    <div class="blog-container">
        ...
        <header class="blog-header animate-on-scroll">
            <span class="blog-tag">// All Articles</span>
            <h1 class="blog-title">
        ...
        <nav class="category-filter animate-on-scroll" id="category-filter">
            <button type="button" 
                ...
                <span class="filter-pill-count"><?php echo $post_count; ?></span>
            </button>
            <?php
            ...
            ?>
                <button type="button" 
                        class="filter-pill <?php echo $gradient_class; ?>" 
        ...
        <div class="posts-grid blog-posts-grid" id="posts-container" 
            ...
            ?>
                <div class="no-posts-message animate-on-scroll">
                    ...
                    <h2>No Posts Yet</h2>
                    <p>There are no articles to display yet. Check back soon for new content!</p>
        ...
        <?php if ($blog_query->have_posts() && $blog_query->max_num_pages > 1) : ?>
            <div class="load-more-container animate-on-scroll" id="load-more-container">
                ...
                <div class="pagination-info">
                    <?php
                    $showing = min($posts_per_page, $blog_query->found_posts);
                    ?>
                    <span class="pagination-showing" id="pagination-info">
                        Showing <span id="showing-count"><?php echo $showing; ?></span> of <span id="total-count"><?php echo $blog_query->found_posts; ?></span> articles
                    </span>
                </div>
            </div>
        <?php endif; ?>
